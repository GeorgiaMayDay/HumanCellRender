...
export class BasicTour extends Tour {
    constructor() {
        ...
        const stage_3_description = "This is a Ribosome. They synthesize proteins. They do this by <br> 1. Reading messages from the DNA, which tell them what to build <br> 2. Then gathering amino acids floating in the cytoplasm <br> 3. Then stringing those amino acids together. <br> They are found both free floating in the cell and within embedded in the Endoplasmic Reticulum.";
        ...
        const stage_5_description = "This is the Cell Membrane; it holds the cell together and controls the movement of substances in and out of the cell. It does this through active transport, active transport against the concentration gradient, and diffusion, the passive movement of cells from an area of higher concentration to an area of lower concentration. To do active transport, energy produced by the Mitochondria is required.";
