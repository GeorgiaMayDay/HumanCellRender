...
export const nucleolus_basic = "<p> The Nucleus is the large complex structure that contains the cell's chromosomes, its genetic material.</p> " +
...
export const nucleolus_adv = "<p> The container and organiser of chromatin, the mix of protein and DNA, the nucleus is the most important organelle in human cells.</p>" +
    "<p> The nucleus performs many roles. It replicates DNA and uses ribosomes, to create messenger RNA (mRNA). Like DNA, mRNA is a nucleic acid, which is created by copying genes from the DNA. Since mRNA chunks are smaller the DNA, they are able to leave the cell.   </p>" +
...
export const rough_ER_basic = "<p> The Rough Endoplasmic Reticulum is made up of a web of folded membrane, which are pocketed with ribosomes, which synthesise proteins, the main function of the Rough ER (the smooth ER focuses on making lipids). </p>" +
    " <p> The ribosome pockmarks are why it's known was the Rough Endoplasmic Reticulum.  </p>";

export const rough_ER_adv = "<p> The Endoplasmic Reticulum (ER) is the largest organelle in the human cell, often accounting for 10% of the cells volume. However the ER is shifting in shape and size, so this is not always true - even in the same cell   </p>" +
...
export const smooth_ER_adv = "<p>The Endoplasmic Reticulum (ER) is the largest organelle in the human cell, often accounting for 10% of the cells volume. However the ER is shifting in shape and size, so this is not always true - even in the same cell. </p>" +
...
export const centrioles_basic = "<p> This pair of organelles are used to pull the cell apart in both mitosis and meiosis.  </p>" +
    ...
    "<p> Meiosis is only done by reproductive cells and is when a parent cell splits into 4 haploid cells, containing only half the genes as the parent.  The haploid cells are gametes like sperm and eggs.</p>";

export const centrioles_adv = "<p> This pair of organelles are used to pull the cell apart in both mitosis and meiosis.  </p>" +
    "<p>Mitosis is the division of a parent cell into daughter cells. These daughter cells are genetically identical to each other and to the parent cell. </p>" +
    "<p>" +
    "<p> When they are not involved to dividing, they sit as they do here, at right angles to each other, making up part of the centrosome that is used to form the spindles that splits the cell in nuclear division. </p>" +
    "<p> The centrosome also provides structure and support to the cell by producing and organising strings of proteins that are strong and inflexible called microtubules. These are then manipulated by the centromes and its component centrioles to perform many tasks, often ones specialised for the type of cell. </p>";

export const nuclear_envelope_basic = "<p> The Nuclear Envelope is a complex membrane that surrounds the nucleus. It has with circular holes surrounded by proteins, known as nuclear pores.</p>" +
...
export const nuclear_envelope_adv = "<p>  The nuclear envelope is a multi-layer membrane, which separate the nucleus from the cytoplasm. Acting as this barrier, it is able to regulates what comes in and out of the nucleus. </p>" +
...
export const nucleus_adv = "<p>The container and organiser of chromatin, the mix of protein and DNA, the nucleus is the most important organelle in human cells.</p>" +
    ...
    "<p> Once the mRNA leaves the cell, it finds a ribosome. The ribosome uses the information encoded in the mRNA to create proteins, in a process called translation. </p>" +
...
export const ribosome_basic = "<p> These protein complexes are where proteins are made. This why most of them are found in the membrane of the Rough Endoplasmic Reticulum, the organelle that is the first stage in protein synthesis.</p>" +
