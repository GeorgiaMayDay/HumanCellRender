...
export const nucleolus_basic = "Part of the nucleus, the nucleolus constructs the subunits that will make up ribosomes. Ribsomal sub-units are built out of ribosomal RNA, a nucleric acid like DNA, and protiens . </p> " +
...
export const nucleolus_adv = "<p> Part of the nucleus, the nucleolus is the largest structure in the nucleus. It's main role is to produce ribosomal subunits. </p>" +
    "<p> Ribosomal subunits combine in pairs to create ribosomes, though that process occurs outside the nucleolus. These ribosomal subunits are contructed of ribosomal RNA (rRNA) and protiens</p>" +
...
// "<p> RNA is created by protiens that copying DNA into RNA, a process known as transcription. This forms m-RNA which is then further processed within the nucleous before moving into the cytoplasm and entering a ribosome. The ribosome then creates the protien encoded onto the RNA, in a process known as protien synthesis </p>";
...
//Needs more work
export const lysosome_adv = "<p> Lysosomes are membrane-enclosed organelles that act the digestive system of the cell. They breakdown protiens, nucleic acids(DNA and RNA), carbohydrates, and lipids. </p> <p>Although portrayed as a sphere here, they actually come in a variety of shapes and sizes, due to being only defined by being a membrane-bound structure filled with digestive enzymes </p>.";

export const golgi_body_basic = "<p> The Golgi body, also known as the Golgi Apparatus, is an organelle made of folded membrane sacs. It is involved in protien processing. </p>" +
    "<p> Protiens and other molecules, leave the Endoplasmic Recticulum and the Golgi Body absorbs them. The Golgi Body adds any more molecules, if needed, and wraps them in a membrane sac (known as a vesicles). </p>" +
    "<p>The protiens, in their vesciles can then can be moved to their final destination </p>";
...
export const golgi_body_adv = "<p> The Golgi Body, or Golgi Apparatus, is a made up of a series of stacked, folded membranes. These flattened sacs are known as cisternae. It is located next to the nucleus, in what's known as the perinuclear position. </p>" +
    "<p> The primary function of the Golgi Body is processing and sorting protiens, though it does also sort lipids in a similar manner. </p>" +
    "<p> Processing means modifying the protien by adding other materials. For example, it could add carbohydrates to a protein, creating a composite known as a glycoprotien. </p>" +
    "<p> Once the products have been processed, they get wrapped in a vesicle, a membrane sac. The type of vesicle the product is wrapped in tells the cells where to send the protien. </p> " +
...
export const rough_ER_adv = "<p>The Endoplasmic Recticulum (ER) is the largest organelle in the human cell, often accounting for 10% of the cells volume. However the ER is shifting in shape and size, so this is not always true - even in the same cell </p>" +
    "<p> The  Endoplasmic Recticulum is made up of a series of cistarne (sacs of membrane), folded over each other to create channels. The membrane is not just a lipid bilayer containing with ribosomes and protiens. These ribosomes and proteins are both part of the process of protien synthesis </p>" +
    "<p> The Rough ER is essential for protien synthesis in mammalian cells, even protiens produced by free-floating ribosomes must go through the Rough ER before being used. Within the Rough ER, these proteins are processed further, which tells them which organelle they should go to next. </p>";

export const smooth_ER_basic = "<p> The Smooth Endoplasmic Recticulum is part of the Endoplasmic Recticulum (ER) - the largest organelle in the cell. It is made up of a number of tubular, interconnected, membranes. </p>" +
    "<p> While the Rough ER is focused on protien processing, the Smooth ER is focused on lipid synthesis. These lipids are used to construct and repair membranes across the cell. </p>";

export const smooth_ER_adv = "<p> Part of the Endoplasmic Recticulum, the Smooth ER is different to the Rough in shape and function. </p>" +
    "<p> It's does not have any ribosomes on the surface, hence being called smooth, and is more tubular. The different look follows from it performing a different function to the Rough ER.</p>" +
...
export const nuclear_envelope_basic = "<p> A complex membrane around the nucleus. Molecules can only pass through the nuclear pore complexes, the circluar holes surrounded by protiens in the membrane.</p>" +
...
export const nuclear_envelope_adv = "<p> The nuclear enveolope is a multi-layer membrane, which seperaete the nucleus from the cytoplasm. Acting as this barrier, it is able to regulates what comes in and out of the nucleus </p>" +
    ...
    "<p> The outer membrane can connects to the rough Endoplasmic Recticulum and has ribsomes studded within it. The inner nuclear membrane contains protiens that support the inner workings for the nucleus. </p>" +
...
export const cytsol_basic = "<p> Cytsol is the liquid part of the Cytoplasm, a term used for the space between the cell membrane and the nucleus. The fluid maintains the shape of the cell and fills the void between organelle</p>" +
...
export const cytsol_adv = " <p> Cytsol is the liquid in cell, seperated from organelle and contained by membranes. </p>" +
...
export const nucleus_adv = "<p> The container and organiser of chromatin, the mix of protein and DNA, the nucleus is the most important organelle in human cells. </p>" +
    ...
    "<p> Within the nucleus, there are sub-structures dedicated to performing different internal functions - for example, the nuceleolus which constructs ribosomes.  </p>" +
...
export const ribosome_basic = "<p> These protien complexes are where protiens are made. This why most of them are found in the membrane of the  Rough ER, the organelle that is the first stage in protien processing. </p> <p> They recieve messenger RNA from the nucleus and read it, in a process called translation. </p><p>The RNA tells them what order they should connect amino acid together to make a protien.</p> <p> They are created within the nucleus </p>";

export const ribosome_adv = "<p> Ribosomes are molecular machines responsible for the creation of protiens from amino acids </p> " +
    "<p> Ribsomes are made up of two sub-units that process messenger RNA (mRNA) in the gap between. It then matches the mRNA code with the appriopriate amino acid. </p>" +
    "<p> It does this by matching sections of the mRNA code, 3 letter sequences called codons, to transfer RNA (tRNA), a short nucelic acid with a matching amino acid attached </p>" +
    "<p> The ribsome takes the amino acid off the tRNA and adds it the protien string. This process goes on til the ribosome hits the stop codon - a specific sequence at the end of all mRNA </p>" +
    "<p> This process is known as translation and it is the foundational process from which all proteins, enzymes, ion channels and horomones are built from. </p>" +
    "<p> Ribsomes are created in the nuleolus, within the nucleus. </p>";